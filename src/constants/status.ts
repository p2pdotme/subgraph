...
export const PAYMENT_CHANNEL_STATUS_DEFAULT: i32 = 0;
export const PAYMENT_CHANNEL_STATUS_PENDING: i32 = 1;
export const PAYMENT_CHANNEL_STATUS_APPROVED: i32 = 2;
export const PAYMENT_CHANNEL_STATUS_REJECTED: i32 = 3;
export const PAYMENT_CHANNEL_STATUS_ON_HOLD: i32 = 4;
export const PAYMENT_CHANNEL_STATUS_TERMINATED: i32 = 5;
